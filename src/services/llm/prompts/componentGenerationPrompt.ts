...
- If this component is a dashboard tab/panel, also include a "Top Insights" section (a .section-title plus a .insight-panel) with exactly 3 <InsightCard> items from '../components/InsightCard', computed from the data. For financial/transactional data these are the top 3 SPENDING & SAVINGS insights (tone="spend"/"save", each with title, metric, one-line detail, and high/medium/low confidence); for other data, the 3 most useful observations. Never hand-roll insight tiles
